...
module.exports = {
  mailer: {
    account_confirmation: {
      subject: 'Bem vindo ao IrisRPG',
      title: 'Bem vindo ao IrisRPG!',
      header: 'Bem vindo ao IrisRPG!',
    ...
    password_recovery: {
      ...
      paragraph2: 'Recebemos uma solicitação de recuperação de senha no IrisRPG.',
